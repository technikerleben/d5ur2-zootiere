...
- Kinder arbeiten auf Papier und im Heft. Ein Kontroll-Kiosk am Raum-Laptop ergänzt die Hilfen; die Website ist für das Kollegium.
- Phasen: **Planung → Durchführung → Reflexion**.
- Lernweg: **Input → Übung → Vertiefung → Probearbeit → Projekte → Lernerfolgskontrolle (Arbeit)**. Vertiefungen und Projekte bleiben freiwillig.
- Die Probearbeit ist verpflichtend und unbenotet. Übungen werden nach Lernbedarf vereinbart.
- Lernbuddy-Nutzung und fachliche Textleistung werden getrennt rückgemeldet.
